      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-5">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-zinc-200 border border-zinc-700 text-xs font-semibold transition-all hover:text-white"
          >
      ...
      <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
        ...
        <div className="shrink-0 flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-semibold border border-zinc-700 flex items-center gap-1.5 transition-colors"
      ...
      <div className="bg-[#121212] border border-zinc-800 rounded-2xl p-5 sm:p-6 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-800 pb-3 mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={refreshData}
              className="px-2.5 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 text-zinc-300 text-xs font-semibold border border-zinc-800 flex items-center gap-1.5 transition-colors"
            >
            ...
            {events.length > 0 && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-zinc-900 hover:bg-red-500/20 text-zinc-400 hover:text-red-300 text-xs font-semibold border border-zinc-800 flex items-center gap-1.5 transition-colors"
              >
